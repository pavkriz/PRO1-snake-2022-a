...
public class MainWindow extends JFrame {
    private final Timer timer = new Timer(100, e -> tick());    // casovac, ktery spousti metodu tick kazdych 100ms
    private final GameBoard gb = new GameBoard();   // presunuto z kostruktoru sem, mj. aby byla promenna gb viditelna v tick()
    private final CanvasPanel p = new CanvasPanel(gb);
